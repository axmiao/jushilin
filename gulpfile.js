...
// build函数
// gulp.task('build', ['copy-index', 'images', 'scripts', 'sass', 'css','font', 'copy-html'], function(){
//   runSequence('concat');
//   console.log('编译成功！');
// });
gulp.task('build', ['sass', 'less', 'font', 'scripts', 'copy-index', 'copy-html', 'data', 'css', 'images'], function(){
  runSequence('concat');
  console.log('编译成功！');
});
